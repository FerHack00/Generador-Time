...
def usage():
    ...
    print("-------HERRAMIENTA DE YISUSXD---------------")
    print("------TODOS LOS CREDITOS A YISUSXD")
    print("_____________ $$$$$_________________________
...
_______________$$$______$$_Y_$$______$$$_______________
...
________________________$$___$$________________________
________________________$$_U_$$________________________
________________________$$___$$________________________
________________________$$_S_$$________________________
________________________$$___$$________________________
________________________$$_X_$$________________________
________________________$$___$$________________________
________________________$$_D_$$________________________
________________________$$___$$________________________
________________________$$_1_$$________________________
________________________$$___$$________________________
________________________$$_1_$$________________________
________________________$$___$$________________________
________________________$$_1_$$________________________
...
___________________________$___________________________
    ...
    print(" ./Generation time.py [-b] 123456xxxxxxxxx -u CANTIDAD -d -c")
    print("    ./Generation time.py -h [AYUDA]")
    print("-------------------------------------------------------------")
    print("####################Opciones:#################################")
    print("    -b, Colocar bin  Formato de bin")
    print("    -u, Cantidad     Cantidad de tarjetas")
    print("    -c, Ccv          Genera ccv")
    print("    -d, Datos(fecha) Genera fecha de expiracion")
    print("    -g, Guardar      Guarda las tarjetas")
    print("##########SIGNIFICAO DE CADA COMANDO###########")
